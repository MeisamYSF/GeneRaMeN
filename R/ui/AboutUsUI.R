...
tabPanel("About us",
         ...
         fluidRow(
           ...
           column(6,
                  ...
                  br(),
                  p("GeneRaMeN is open source and free for all academic and educational purposes, our source code can be found at", a("GitHub", href = "https://github.com/MeisamYSF/GeneRaMeN"), "under a", a("GPLv2", href = "https://choosealicense.com/licenses/gpl-2.0/"), "licesnce. GeneRaMeN app can also be downloaded and run locally on any computer/system with R installed.", style = "font-size:20px;"),
                  br(),
                  p("If you have used GeneRaMeN in your work, please cite its journal article at <>"),
                  br(),
                  br(),
